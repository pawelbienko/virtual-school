...
class Virtual_School {
	...
	public function __construct() {
		...
		$this->plugin_name = 'virtual-school';
		$this->version = '1.0.0';
	...
	private function load_dependencies() {
		 ...
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-'.$this->plugin_name.'-public.php';

		$this->loader = new Virtual_School_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Virtual_School_i18n();
