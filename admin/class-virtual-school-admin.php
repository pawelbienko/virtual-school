 ...
 * @subpackage Virtual_School/admin
 * @author     Your Name <email@example.com>
 */
class Virtual_School_Admin {
	...
	public function enqueue_scripts() {
        ...
        public function add_plugin_admin_menu() {
             ...
             *
             */
            add_options_page( 'WP Virtual School', 'WP Virtual School', 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page')
            );
        }
       ...
       public function display_plugin_setup_page() {
           include_once( 'partials/virtual-school-admin-display.php' );
       }
